    ...
    return(
        ...
        <Container>
            ...
            <Row>
                ...
                <Col lg={8}><h4 className="abouttext">Hi my name is Ben Abbott and I am a web designer. I have over 2 years of professional web design experience. I have worked on a wide range of projects from simple portfolio websites to more complex, data integrated websites. I also have a history of project management for website projects, from initial design all the way through the delivery of the final product. </h4>
                <br/>
